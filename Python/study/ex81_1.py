...
try :
    ...
    cursor.execute("insert into mem values('김기태', '010-1234-1234', '서울시')")
    cursor.execute("insert into mem values('김서은', '010-1004-1004', '고양시')")
    cursor.execute("insert into mem values('심인보', '010-2424-2424', '파주시')")
